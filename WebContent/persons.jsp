...
<body class="">
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <!-- chart-part -->
            <div class="show-part ">
                 <table id="persons-chart" lay-filter="persons"></table>
            </div>
        <!-- chart-part -->
        ...
        <!-- nav -->
            <div class="nav-part ">
                ...
                <button id="export" class="layui-btn layui-btn-radius layui-btn-primary">导出数据</button>              
            </div>
        <!-- nav -->
        </div>
...
<script src="src/js/persons.js"></script>
<!-- <script src="../src/module/jsontoexcel/JsonExportExcel.min.js"></script>
<script src="../src/js/persons2.js"></script> -->
