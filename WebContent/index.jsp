    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="header">
            <ul class="layui-nav" lay-filter="">
                ...
                <li class="layui-nav-item" id="index-page"><a href="#">home</a></li>
        ...
        <div class="fliter layui-row">
            <form class="layui-form" action="">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <div class="layui-input-inline in3">
                            <input type="checkbox" name="notChckin" title="未打卡"><div class="layui-unselect layui-form-checkbox layui-form-checked"><span>未打卡</span><i
        ...
        <!-- chart-part -->
            <div class="show-part ">
                 <table id="look-chart" lay-filter="look-chart"></table>
            </div>
        <!-- chart-part -->
